    ...
    <main className="flex flex-col">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-[6vh] md:bottom-15 lg:bottom-[10vh] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center cursor-pointer bg-transparent border-none group"
        >
