  ...
  return (
    <main className="flex flex-col">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        {/* Conteúdo */}
        <div className="relative z-10 flex h-full flex-col items-start justify-center text-left mt-20 px-8 ml-0 md:ml-64 md:px-16">
          ...
          <div className="pt-50 flex md:-ml-64 self-center gap-8">
