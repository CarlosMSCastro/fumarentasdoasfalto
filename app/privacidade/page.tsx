...
export default function PrivacidadePage() {
  return (
    <PaginaLegal titulo="Política de Privacidade">
      ...
      <h2 className="text-white/90 text-2xl font-bold mt-8">1. Dados Recolhidos</h2>
      ...
      <h2 className="text-white/90 text-2xl font-bold mt-8">2. Finalidade</h2>
      <p>Os dados recolhidos destinam-se exclusivamente à gestão de sócios, comunicação de eventos e atividades da associação.</p>
      <h2 className="text-white/90 text-2xl font-bold mt-8">3. Armazenamento</h2>
      ...
      <h2 className="text-white/90 text-2xl font-bold mt-8">4. Direitos</h2>
