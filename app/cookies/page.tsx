...
export default function CookiesPage() {
  return (
    <PaginaLegal titulo="Política de Cookies">
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">1. O que são Cookies</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">2. Tipos de Cookies Utilizados</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">3. Cookies de Terceiros</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">4. Gestão de Cookies</h2>
