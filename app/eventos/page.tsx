    ...
    <div id="snap-container" className="snap-y snap-mandatory overflow-y-scroll h-dvh">
      <section className="relative h-dvh w-full overflow-hidden snap-start">
        ...
        <div className="flex h-full flex-col">
          <div className="relative z-0 w-[94vw] md:w-[79vw] mx-auto opacity-95 flex-1 min-h-0 flex flex-col items-end justify-start pb-[clamp(1.5rem,8dvh,10rem)] md:pb-[13dvh] [@media(min-width:768px)_and_(max-width:1728px)_and_(max-height:950px)]:pb-[9dvh]">
