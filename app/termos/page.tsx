...
export default function TermosPage() {
  return (
    <PaginaLegal titulo="Termos e Condições">
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">1. Utilização do Site</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">2. Associação</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">3. Responsabilidade</h2>
      ...
      <h2 className="text-white/90 text-xl font-bold mt-8">4. Privacidade</h2>
