    ...
    <section className="flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-col lg:hidden pl-2 px-3 py-8 gap-2">
        <div className="p-6">
          ...
          <div className="flex flex-col gap-3 text-white/70 text-xl">
            <div className="flex justify-between pr-2"><span className="font-bold text-white/90">Seg. a Sex.</span><span>10:30 às 18:00</span></div>
            <div className="flex justify-between pr-2"><span className="font-bold text-white/90">Sáb.</span><span>10:30 às 18:00</span></div>
            <div className="flex justify-between pr-2"><span className="font-bold text-white/90">Dom.</span><span>Fechado</span></div>
          </div>
        </div>
        <div className="p-6">
        ...
        <div className="flex gap-2">
          ...
          <div className="p-6 flex-1 flex flex-col items-center justify-center gap-2 -mt-5">
            <p className="text-orange-500 uppercase tracking-widest text-xl font-bold mb-1">Quer ser membro?</p>
            <a href="https://app.quotagest.com/app/inscricao/628097740e7fe9b9" className="rounded-full bg-orange-500 px-9 py-2 font-bold uppercase tracking-widest text-white text-xl hover:bg-orange-600 transition-all text-center">
              Formulário
            </a>
          </div>
        </div>
