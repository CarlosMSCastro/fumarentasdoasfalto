    ...
    <div className="w-full mx-auto flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-3 md:p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6 content-start">
      {produtos.map((produto, i) => {
        ...
        return (
          <div
            key={produto.id}
            className={`group relative flex flex-col rounded-sm overflow-hidden bg-[#f8f0d9] shadow-[0_18px_35px_rgba(0,0,0,100)] transition-all duration-700 ease-out hover:z-10 ${rotate} ${hoverRotate}`}
          >
