...
export default function ObjetivosSection() {
  return (
    <section id="sobre" className="flex flex-col items-center justify-center min-h-dvh pt-15 pb-22 md:py-30 gap-2 relative overflow-hidden snap-start snap-always">
      ...
      <div className="absolute inset-0 bg-linear-to-t from-black/10 via-black/20 to-black/90" />
      <video
        className="absolute inset-0 w-full h-full object-cover object-[center_top] opacity-40 md:object-center md:opacity-30 pointer-events-none mix-blend-screen scale-x-[-1]"
