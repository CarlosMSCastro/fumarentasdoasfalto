        ...
        <div className="w-[80%] mx-auto flex-1 min-h-[6.4rem] md:min-h-[10.4rem] md:max-h-[27.2rem] grid grid-cols-3 auto-rows-fr gap-2.5 md:grid-cols-7 md:gap-4">
          {fundadores.map((fundador, i) => (
            <div
              ...
              className="group relative rounded-sm overflow-hidden bg-neutral-800 cursor-pointer"
            >
              <Image
              ...
              <div className="absolute inset-0 flex items-end p-1 md:p-2.5">
                <div className="relative w-full">
                  <span className={`block text-white font-bold uppercase leading-[0.85] text-lg sm:text-base md:text-2xl drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] transition-opacity duration-300 group-hover:opacity-0 ${activeIndex === i ? "opacity-0" : ""}`}>
                    {fundador.nome}
                  </span>
