  ...
  return (
    <div className="hidden md:flex md:flex-row gap-3 w-full px-[8%] lg:px-[13%]">
      ...
      key={i}
        ...
        className="group relative rounded-lg flex-1 md:hover:flex-2 opacity-95 transition-all duration-500 h-[60vh] md:h-[45vh] flex flex-col justify-between p-6 shadow-[0_25px_60px_rgba(0,0,0,0.85)]"
      >
